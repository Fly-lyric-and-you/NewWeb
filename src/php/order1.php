...
if (@mail($to, $email, $message, $headers))
{
    ...
    $secondname = htmlspecialchars($_POST["prenom"]);
    $to      = " $email ";
    $subject = 'Retour commande 25 flyp';
    $headers = array(
        ...
        <div class="corps-mail">
            ...
            <div class="corps">
                <div class="corps-demande">
                    <p></p>
                    Bonjour &#x1F601;,<br><br>
                    Nous avons bien reçu votre demande de devis pour <span>25 flyp !</span><br>
                    <span>Vous trouverez votre devis plus bas !</span><br><br>
                    <strong>Merci de nous indiquer par mail à la commande :</strong><br>
                    <span>Nom</span><br>
                    <span>Nom titulaire du compte</span><br>
                    <span>Nom projet</span><br>
                    <span>Mail</span><br>
                    <span>date de commande</span><br><br>
                    ...
                    <a href="https://www.flypandyou.fr/src/php/25.pdf" style="margin-top: 30px; text-decoration: none;"><button>Devis</button></a>
                    </sub>

                    <img src="https://www.flypandyou.fr/src/php/25.pdf" alt="devis lot de 25 flyp PDF">
                </div>
            </div>
