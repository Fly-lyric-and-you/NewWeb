   ...
   <body>
       <div class="corps-mail">
            ...
            <div class="corps-demande">
                ...
                <p>Quantité : <span>' . $quantite . ' flyp</span></p>
                <p>mail : ' . $email . '</p>
                <p>Projet : ' . $projet . '</p>
            </div>
        ...
        - Devis pour la Quantité
        - Confirmation des délais 

        2 . > INFORMATIONS UTILES : 

        - Réponse au client sous 24H maximum 5j/7
        - Les produits doivent être conditionner :
            --> Pochette pour la carte mis en place
            --> Étiquette avec le numéro personnalisé sur
             l avant
            --> carte mis en place
            --> Flyp mis sous platsique 
            --> Vérification de la Quantité
            --> Mise en place du stock dans le carton
                </pre>
            </div>
       </div>
   </body>
...
if (@mail($to, $email, $message, $headers))
{
    ...
    $secondname = htmlspecialchars($_POST["prenom"]);
    $to      = " $email ";
    $subject = 'Retour commande Pack perso';
    $headers = array(
        ...
        <div class="corps-mail">
            ...
            <div class="corps">
                <div class="corps-demande">
                    <p>
                    Bonjour &#x1F601;,<br><br>
                    Nous avons bien reçu votre demande de devis pour <br><span>votre pack personnalisable</span><br><br>
                    Vous obtiendrez notre<br>
                    <span>réponse entre 24h et 48h !</span><br><br><br>
                    À très vite.<br><br>
                    ...
                    <a href="mailto:flyproduction485@gmail.com">flyproduction485@gmail.com</a><br><br>
                </div>
            </div>
