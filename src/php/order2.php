        ...
        <div class="corps-mail">
             ...
             <div class="corps">
                <div class="corps-demande">
                    ...
                    <p>Quantité : <span>100 flyp</span></p>
                    <p>mail : ' . $email . '</p>   
                </div>
                <div class="supp">
                    <p>
...
if (@mail($to, $email, $message, $headers))
{
    ...
    $secondname = htmlspecialchars($_POST["prenom"]);
    $to      = " $email ";
    $subject = 'Retour commande 100 flyp';
    $headers = array(
        ...
        <div class="corps-mail">
            ...
            <div class="corps">
                <div class="corps-demande">
                    <p></p>
                    Bonjour &#x1F601;,<br><br>
                    Nous avons bien reçu votre demande de devis pour <span>100 flyp !</span><br>
                    ...
                    <a href="https://www.flypandyou.fr/src/php/100.pdf" style="margin-top: 30px; text-decoration: none;"><button>Devis</button></a>
                    </sub>
